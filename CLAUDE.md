...
- **Surface ambiguity, do not silently resolve.** If the PRD and design doc disagree, ask Hayden. If a spec is incomplete, ask. Do not invent.
...
See `docs/prd.md` §12 for outstanding decisions awaiting Hayden's input. Do not silently resolve any item marked Open.
